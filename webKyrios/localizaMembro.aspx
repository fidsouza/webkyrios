...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" DataKeyNames="idMembro" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="false">
        <Columns>

            <asp:BoundField DataField="idMembro" HeaderText ="Id" />
            <asp:BoundField DataField="nomeMembro"  HeaderText="Nome" />
            <asp:BoundField DataField="dataNascMembro" HeaderText="Data de Nascimento" />
            <asp:BoundField DataField="emailMembro" HeaderText="E-mail"  />
            <asp:BoundField DataField="telCelMembro" HeaderText="Celular" />
        </Columns>
